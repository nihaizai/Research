...
def train(model, criterion_xent, criterion_cent,
    ...
    for batch_idx, (data, labels) in enumerate(trainloader):
        ...
        print('features.size:{}'.format(features.shape))  #[batch_size,2]
        ...
        if args.plot:
            if use_gpu:
                ...
                print("all_features.shape:{}".format(len(all_features)))  #total num/batch_size
                print("all_labels.shape:{}".format(len(all_labels)))  #[total num/batch_size,]
            else:
    ...
    if args.plot:
        ...
        print("concat  all_labels.shape:{}".format(len(all_labels)))
        print("concat   all_features.shape:{}".format(len(all_features)))
...
def plot_features(features, labels, num_classes, epoch, prefix):
    ...
    Args:
        features: (num_instances, num_features).e-
        labels: (num_instances). 
    """
    colors = ['C0', 'C1', 'C2', 'C3', 'C4', 'C5', 'C6', 'C7', 'C8', 'C9']
    for label_idx in range(num_classes):
        #print('features[labels==label_idx,0]:{}'.format(features[labels==label_idx,0]))
        #print('features[labels==label_idx,1]:{}'.format(features[labels==label_idx,1]))
        plt.scatter(
